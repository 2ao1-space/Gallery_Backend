    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10aef1a3-3b27-4922-a56a-b06c304a9454"), "Edit own pins", "edit_pin" },
                    { new Guid("1b94d6f3-96db-411d-a8e9-a59e16056710"), "Manage users", "manage_users" },
                    { new Guid("526ca2e4-6e0a-48f6-82a3-e0eff438886d"), "Moderate content", "moderate_content" },
                    { new Guid("5fb71846-1b74-4cc0-a17f-45ea67eb3dac"), "Create pins", "create_pin" },
                    { new Guid("7a4ce168-ddb6-46d8-9c38-9d4a678d9990"), "Delete own pins", "delete_pin" },
                    { new Guid("b36d975d-699d-4a38-8e7f-c2dab4927099"), "Save pins", "save_pin" },
                    { new Guid("fbf9b575-fa50-4603-92b4-8f1ba7f8f5d7"), "Comment on pins", "comment" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("33333333-3333-3333-3333-333333333333"), "Moderator role", "Moderator" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PendingEmailChanges_UserId_IsCompleted",
